...
from finetune.segment_custom_data.v3c_datamodule import MultiobjectV3CDataModule  # noqa: F401
from finetune.segment_custom_data.v3c_model import MultiobjectV3CSegmentor  # noqa: F401
...
def cli_main():
    ...
    """
    cli = LightningCLI(MultiobjectV3CSegmentor, MultiobjectV3CDataModule)
    return cli
